...
export class InventoryComponent implements OnInit {
    ...
    colDefs: ColDef[] = [
        ...
        },
        {
            ...
            filter: 'agSetColumnFilter',
            tooltipField: 'lowStockThreshold',
