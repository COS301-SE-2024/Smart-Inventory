...
export class InventoryComponent implements OnInit {
    ...
    colDefs: any[] = [
        { elementType: 'input', field: 'sku', editable: true },
        { elementType: 'input', field: 'productId', editable: true },
        { elementType: 'input', field: 'description', editable: true },
        { elementType: 'input', field: 'quantity', editable: true },
        { elementType: 'input', field: 'supplier', editable: true },
    ];
